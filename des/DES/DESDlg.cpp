...
void CDESDlg::OnButton4() //open learn dlg
{
    EndDialog(IDCANCEL);
	LEARN dlg;
	dlg.DoModal();
...
void CDESDlg::OnButton5() //open game dlg
{
	EndDialog(IDCANCEL);
	GAME dlg;
	dlg.DoModal();
...
void CDESDlg::OnButton6() //open test dlg
{
	EndDialog(IDCANCEL);
	TEST dlg;
	dlg.DoModal();
